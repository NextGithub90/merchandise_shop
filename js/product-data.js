...
const PRODUCT_DB = [
  // ══ WOTAKU SHOP - FIGURE ══
  { id:'kitsune-figure', name:'Kitsune Spirit Anime Figure', brand:'Wotaku Shop', brandLogo:'assets/images/logo_wotaku.png', store:'wotaku', cat:'Figure', badge:'new', price:385000, originalPrice:450000, rating:4.8, reviewCount:24, stock:12,
    images:['assets/images/prod_figure.png','assets/images/prod_cosplay.png','assets/images/prod_acrylic.png'],
  ...
  { id:'dragon-figure', name:'Dragon Premium Collector Figure', brand:'Wotaku Shop', brandLogo:'assets/images/logo_wotaku.png', store:'wotaku', cat:'Figure', badge:'limited', price:680000, originalPrice:null, rating:4.9, reviewCount:31, stock:5,
    images:['assets/images/prod_figure.png','assets/images/prod_acrylic.png','assets/images/prod_figure.png'],
  ...
  { id:'samurai-figure', name:'Samurai Mini Figure Set', brand:'Wotaku Shop', brandLogo:'assets/images/logo_wotaku.png', store:'wotaku', cat:'Figure', badge:'new', price:295000, originalPrice:null, rating:4.7, reviewCount:18, stock:20,
    images:['assets/images/prod_figure.png','assets/images/prod_acrylic.png','assets/images/prod_cosplay.png'],
  ...
  // ══ WOTAKU SHOP - COSPLAY ══
  { id:'sakura-cosplay', name:'Sakura Kimono Cosplay Set', brand:'Wotaku Shop', brandLogo:'assets/images/logo_wotaku.png', store:'wotaku', cat:'Cosplay', badge:'limited', price:520000, originalPrice:null, rating:4.9, reviewCount:37, stock:8,
    images:['assets/images/prod_cosplay.png','assets/images/prod_figure.png','assets/images/prod_harajuku.png'],
  ...
  { id:'kitsune-mask', name:'Kitsune Fox Mask Set', brand:'Wotaku Shop', brandLogo:'assets/images/logo_wotaku.png', store:'wotaku', cat:'Cosplay', badge:'new', price:380000, originalPrice:null, rating:4.6, reviewCount:22, stock:15,
    images:['assets/images/prod_cosplay.png','assets/images/prod_acrylic.png','assets/images/prod_figure.png'],
  ...
  // ══ WOTAKU SHOP - ACRYLIC ══
  { id:'anime-acrylic', name:'Anime Acrylic Standee Collection', brand:'Wotaku Shop', brandLogo:'assets/images/logo_wotaku.png', store:'wotaku', cat:'Acrylic', badge:'new', price:95000, originalPrice:null, rating:4.8, reviewCount:45, stock:50,
    images:['assets/images/prod_acrylic.png','assets/images/prod_figure.png','assets/images/prod_tshirt.png'],
  ...
  { id:'sakura-keychain', name:'Sakura Character Keychain Acrylic', brand:'Wotaku Shop', brandLogo:'assets/images/logo_wotaku.png', store:'wotaku', cat:'Acrylic', badge:'', price:75000, originalPrice:null, rating:4.7, reviewCount:63, stock:100,
    images:['assets/images/prod_acrylic.png','assets/images/prod_cosplay.png','assets/images/prod_figure.png'],
  ...
  // ══ WOTAKU SHOP - T-SHIRT ══
  { id:'torii-tee', name:'Torii Gate Graphic Tee', brand:'Wotaku Shop', brandLogo:'assets/images/logo_wotaku.png', store:'wotaku', cat:'T-Shirt', badge:'sale', price:145000, originalPrice:195000, rating:4.7, reviewCount:52, stock:30,
    images:['assets/images/prod_tshirt.png','assets/images/prod_hoodie.png','assets/images/prod_acrylic.png'],
  ...
  { id:'samurai-tee', name:'Samurai Ink Art Graphic Tee', brand:'Wotaku Shop', brandLogo:'assets/images/logo_wotaku.png', store:'wotaku', cat:'T-Shirt', badge:'new', price:165000, originalPrice:null, rating:4.6, reviewCount:28, stock:25,
    images:['assets/images/prod_tshirt.png','assets/images/prod_acrylic.png','assets/images/prod_hoodie.png'],
  ...
  // ══ MND.ID - STREETWEAR ══
  { id:'tokyo-hoodie', name:'Tokyo Kanji Oversized Hoodie', brand:'mnd.id', brandLogo:'assets/images/logo_mnd.png', store:'mnd', cat:'Streetwear', badge:'new', price:295000, originalPrice:null, rating:4.9, reviewCount:67, stock:20,
    images:['assets/images/prod_hoodie.png','assets/images/prod_tshirt.png','assets/images/prod_harajuku.png'],
  ...
  { id:'shibuya-cargo', name:'Shibuya Night Cargo Pants', brand:'mnd.id', brandLogo:'assets/images/logo_mnd.png', store:'mnd', cat:'Streetwear', badge:'', price:335000, originalPrice:null, rating:4.8, reviewCount:43, stock:18,
    images:['assets/images/prod_hoodie.png','assets/images/prod_harajuku.png','assets/images/prod_tshirt.png'],
  ...
  { id:'sakura-streetwear', name:'Sakura Streetwear Graphic Tee', brand:'mnd.id', brandLogo:'assets/images/logo_mnd.png', store:'mnd', cat:'Streetwear', badge:'sale', price:125000, originalPrice:165000, rating:4.7, reviewCount:89, stock:35,
    images:['assets/images/prod_tshirt.png','assets/images/prod_hoodie.png','assets/images/prod_harajuku.png'],
  ...
  // ══ MND.ID - HARAJUKU ══
  { id:'harajuku-outfit', name:'Harajuku Layer Outfit Set', brand:'mnd.id', brandLogo:'assets/images/logo_mnd.png', store:'mnd', cat:'Harajuku', badge:'new', price:445000, originalPrice:null, rating:4.9, reviewCount:41, stock:12,
    images:['assets/images/prod_harajuku.png','assets/images/prod_hoodie.png','assets/images/prod_tshirt.png'],
  ...
  { id:'harajuku-tote', name:'Harajuku Graphic Tote Bag Set', brand:'mnd.id', brandLogo:'assets/images/logo_mnd.png', store:'mnd', cat:'Harajuku', badge:'new', price:380000, originalPrice:null, rating:4.8, reviewCount:28, stock:22,
    images:['assets/images/prod_harajuku.png','assets/images/prod_tshirt.png','assets/images/prod_hoodie.png'],
  ...
  { id:'kawaii-accessory', name:'Kawaii Street Accessory Set', brand:'mnd.id', brandLogo:'assets/images/logo_mnd.png', store:'mnd', cat:'Harajuku', badge:'', price:290000, originalPrice:null, rating:4.7, reviewCount:35, stock:40,
    images:['assets/images/prod_harajuku.png','assets/images/prod_acrylic.png','assets/images/prod_tshirt.png'],
  ...
  // ══ MND.ID - KOREAN STYLE ══
  { id:'korean-dress', name:'Korean Harajuku Dress Set', brand:'mnd.id', brandLogo:'assets/images/logo_mnd.png', store:'mnd', cat:'Korean Style', badge:'limited', price:510000, originalPrice:null, rating:4.9, reviewCount:33, stock:7,
    images:['assets/images/prod_harajuku.png','assets/images/prod_tshirt.png','assets/images/prod_hoodie.png'],
  ...
  { id:'k-style-jacket', name:'K-Style Oversized Jacket', brand:'mnd.id', brandLogo:'assets/images/logo_mnd.png', store:'mnd', cat:'Korean Style', badge:'new', price:420000, originalPrice:null, rating:4.8, reviewCount:19, stock:16,
    images:['assets/images/prod_hoodie.png','assets/images/prod_harajuku.png','assets/images/prod_tshirt.png'],
  ...
  { id:'seoul-tee', name:'Seoul Minimal Graphic Tee', brand:'mnd.id', brandLogo:'assets/images/logo_mnd.png', store:'mnd', cat:'Korean Style', badge:'sale', price:185000, originalPrice:230000, rating:4.7, reviewCount:58, stock:30,
    images:['assets/images/prod_tshirt.png','assets/images/prod_hoodie.png','assets/images/prod_harajuku.png'],
  ...
  // ══ AIKOKU - PLUSHIE ══
  { id:'rilakkuma-plushie', name:'Rilakkuma Plushie XL', brand:'Aikoku', brandLogo:'assets/images/logo_AIKOKU.png', store:'aikoku', cat:'Plushie', badge:'new', price:185000, originalPrice:null, rating:5.0, reviewCount:48, stock:25,
    images:['assets/images/prod_acrylic.png','assets/images/prod_acrylic.png','assets/images/prod_figure.png'],
  ...
  { id:'cinnamoroll-plushie', name:'Cinnamoroll Plushie Medium', brand:'Aikoku', brandLogo:'assets/images/logo_AIKOKU.png', store:'aikoku', cat:'Plushie', badge:'sale', price:135000, originalPrice:165000, rating:4.9, reviewCount:72, stock:30,
    images:['assets/images/prod_acrylic.png','assets/images/prod_figure.png','assets/images/prod_acrylic.png'],
  ...
  // ══ AIKOKU - SANRIO ══
  { id:'kuromi-figure', name:'Kuromi Mini Figure Set', brand:'Aikoku', brandLogo:'assets/images/logo_AIKOKU.png', store:'aikoku', cat:'Sanrio', badge:'limited', price:120000, originalPrice:null, rating:4.8, reviewCount:39, stock:15,
    images:['assets/images/prod_acrylic.png','assets/images/prod_figure.png','assets/images/prod_acrylic.png'],
  ...
  { id:'hello-kitty', name:'Hello Kitty Collector Set', brand:'Aikoku', brandLogo:'assets/images/logo_AIKOKU.png', store:'aikoku', cat:'Sanrio', badge:'new', price:145000, originalPrice:null, rating:4.9, reviewCount:55, stock:20,
    images:['assets/images/prod_acrylic.png','assets/images/prod_figure.png','assets/images/prod_acrylic.png'],
  ...
  { id:'kawaii-keychain', name:'Kawaii Acrylic Keychain Set', brand:'Aikoku', brandLogo:'assets/images/logo_AIKOKU.png', store:'aikoku', cat:'Keychain', badge:'limited', price:65000, originalPrice:null, rating:4.7, reviewCount:91, stock:80,
    images:['assets/images/prod_acrylic.png','assets/images/prod_acrylic.png','assets/images/prod_figure.png'],
  ...
  { id:'kawaii-tote', name:'Kawaii Sanrio Tote Bag', brand:'Aikoku', brandLogo:'assets/images/logo_AIKOKU.png', store:'aikoku', cat:'Tote Bag', badge:'new', price:95000, originalPrice:null, rating:4.8, reviewCount:44, stock:55,
    images:['assets/images/prod_harajuku.png','assets/images/prod_acrylic.png','assets/images/prod_harajuku.png'],
